...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 17 nov. 2025 à 02:12
...
(1, 'Dupont\r\n', 'Marie', 'dupontmarie48@gmail.com'),
(2, 'Laurent', 'Thomas', 'l.thomas48@gmail.com'),
(3, 'Bernard', 'Sophie', 'bernards.48@gmail.com'),
(4, 'Petit', 'Julien', 'p.julien48@gmail.com'),
(5, 'Roux', 'Camille', 'rouxcamille48@gmail.com');
...
(14, 'La vie de Rouzard', 'Olson Rouzard', 'dans ce livre, l\'auteur raconte les aventure de son frère Tchelson Rouzard, jeune haïtien qui lutte pour sa survie dans un pays déchiré par la guerre, le chaos géopolitique et toutes sortes de derives sociopolitiques.', 'Le Piman', 21, 'livre14.jpeg'),
